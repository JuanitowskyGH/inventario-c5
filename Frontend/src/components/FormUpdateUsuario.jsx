...
export const FormUpdateUsuario = () => {
  ...
  const { user, loading, apellidos, handleChange, updateUser } = rolesHook();
    ...
    <div className="relative overflow-x-auto bg-white shadow-md sm:rounded-lg w-full">
      <form className="max-w-xlg mx-auto p-8" onSubmit={updateUser}>
        ...
        <div className="grid lg:grid-cols-2 gap-4 pt-5">
          ...
          <img
              src={user.imagen ? `${endpoints.base}${user.imagen}` : "/user.jpg"}
              alt="imagen"
          ...
          <div className="grid grid-rows-3 grid-flow-col gap-4 mt-5 pr-8">
            ...
            <div className="relative mb-6">
              ...
              <select
                ...
                value={user.roleId || ""}
                onChange={handleChange}
                className="block rounded-t-lg pb-2.5 px-2.5 pt-3 w-full text-sm text-gray-500 text-left pl-auto border-0 border-b-2 bg-gray-50 border-gray-300 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
              >
