        ...
        <nav className='absolute left-0 top-0 h-20 w-full bg-white'>
            <div className="px-5 py-3 lg:px-5 lg:pl-3">
                ...
                <div className="flex items-center justify-start rtl:justify-end">
                    <button type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                    ...
                    <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Inventario C5</span>
                    </a>
                </div>
