...
import { submitHook } from "../hooks/users/submit.hook"

export const UsuariosForm = () => {

  const { loading, formData, errors, handleChange, handleSubmit } = submitHook();
  ...
  return (
    <div className="relative overflow-x-auto bg-white shadow-md sm:rounded-lg w-full">
      <form className="max-w-xlg mx-auto p-8" onSubmit={handleSubmit}>
        ...
        <p className="mb-8">
          Llena los campos para agregar un nuevo usuario.
          <br />
        ...
        <div className="grid items-end gap-6 mb-6 md:grid-cols-3 sm:grid-cols-2">
          <div className="relative">
            <input
              ...
              className={`block rounded-t-lg px-2.5 pb-3.5 pt-6 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 ${
                errors.nombre ? "input-error" : "border-gray-300"
          ...
          <div className="relative">
            <input
              ...
              id="apellidop"
              className={`block rounded-t-lg px-2.5 pb-3.5 pt-6 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 ${
                errors.apellidop ? "input-error" : "border-gray-300"
              } appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-tlax peer`}
              placeholder=" "
            />
            <label
          ...
          <div className="relative">
            <input
              ...
              id="apellidom"
              className={`block rounded-t-lg px-2.5 pb-3.5 pt-6 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 ${
                errors.apellidom ? "input-error" : "border-gray-300"
              } appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-tlax peer`}
              placeholder=" "
            />
            <label
          ...
          <div className="relative">
            <input
              ...
              id="username"
              className={`block rounded-t-lg px-2.5 pb-3.5 pt-6 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 ${
                errors.username ? "input-error" : "border-gray-300"
              } appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-tlax peer`}
              placeholder=" "
            />
            <label
          ...
          <div className="relative">
            <label htmlFor="default_select" className="sr-only">
              Permisos
            </label>
            <select
              id="default_select"
              ...
              onChange={handleChange}
              className={`block rounded-t-lg pb-2.5 px-2.5 pt-3 w-full text-sm text-gray-500 text-left pl-auto border-0 border-b-2 bg-gray-50 ${
                errors.roleId ? "input-error" : "border-gray-300"
