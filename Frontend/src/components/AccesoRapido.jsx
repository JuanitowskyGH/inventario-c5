...
export const AccesoRapido = ({ role }) => {
  ...
  const gridCols = isAdminOrMod ? "lg:grid-cols-3 md:grid-cols-2" : "lg:grid-cols-2";
  ...
  return (
    <div className="container mx-auto px-6 py-16">
      ...
      <div
        className={`grid ${gridCols} sm:grid-cols-1 px-6 justify-center`}
      >
        {isAdminOrMod && (
        ...
        <div className="flex p-3 justify-center items-center">
          ...
          >
            Inventario
            <span className="text-lg text-default-400 cursor-pointer active:opacity-50 text-white">
            <LibraryBooksIcon style={{ fontSize: 180 }} />
            </span>
          </Link>
        </div>
        <div className="flex p-3 justify-center items-center">
          ...
          >
            ...
            <span className="pt-2 text-lg text-default-400 cursor-pointer active:opacity-50 text-white">
              <DesktopWindowsRoundedIcon style={{ fontSize: 170 }} />
            </span>
          </Link>
        </div>
      </div>
