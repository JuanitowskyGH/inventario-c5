            ...
            <div className="flex justify-center row-span-3">
                ...
                <div className="grid grid-rows-3 grid-flow-col gap-4 mt-5">
                    <div className="mb-3">
                            ...
                            <input type="text" placeholder='Ingrese el nombre completo del responsable' className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-tlax focus:border-blue-tlax block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-tlax dark:focus:border-blue-tlax dark:shadow-sm-light" required />
                    </div>
                    <div className="mb-3">
