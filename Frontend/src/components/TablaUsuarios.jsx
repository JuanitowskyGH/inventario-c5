...
export const TablaUsuarios = () => {
    ...
    const [search] = useState(['id', 'nombre', 'apellidop', 'apellidom', 'username', 'permisos']);
    ...
    return (
        <div className="relative overflow-x-auto shadow-lg bg-white sm:rounded-lg w-full">
            <div className="p-5 text-2xl font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                Lista de usuarios
                <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Aqui puedes ver la lista de los usuarios con detalles. <br/>
                Realiza la busqueda de un registro en especifico con: <b>ID, Nombre, Apellidos, Nombre de usuario y Permisos</b>
                </p>
                ...
                <div className="relative mt-1 pt-3">
                    ...
                    <input type="text" value={globalFilter} onChange={e => setGlobalFilter(e.target.value)} id="table-search" className="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-2/5 bg-gray-50 focus:ring-blue-tlax focus:border-blue-tlax dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar"/>
                </div>
            </div>
