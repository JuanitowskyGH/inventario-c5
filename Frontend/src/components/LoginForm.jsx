...
export const LoginForm = () => {
  ...
  return (
    <form className="mt-16 bg-white p-6 rounded-lg shadow-lg shadow-black w-96">
        ...
        <input type={showPassword ? "text" : "password"} id="password" className="rounded-none bg-gray-50 border border-gray-300 text-gray-900 focus:border-blue-tlax block flex-1 min-w-0 w-full text-sm p-2.5 pr-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="********"/>
