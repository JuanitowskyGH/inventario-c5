...
import { submitHook } from "../hooks/consumibles/submit.hook";
import LoadIcon from "../icons/LoadIcon";
import DesktopWindowsIcon from '@material-ui/icons/DesktopWindows';

export const FormConsumibles = () => {

  const { errors, loading, consumible, cleanForm, handleChange, handleFileChange, handleSubmit } = submitHook();
  ...
  return (
    <div className="relative overflow-x-auto bg-white shadow-md sm:rounded-lg w-full">
      ...
      >
        ...
        >
          <DesktopWindowsIcon className="w-6 h-6 mr-2" />
          Agregar Consumible
        </button>
